...
<head>
    ...
    <link href="<?php echo e(asset('/static/static/font-awesome/css/font-awesome.min.css?page=index')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('/static/themes/admin_simpleboot3/public/assets/themes/flatadmin/simplebootadminindex.min.css')); ?>" rel="stylesheet" type="text/css">
    ...
    <!-- <notempty name="submenus"> -->
        ...
        <li>
            ...
            <a href="javascript:openapp('<?php echo e($menu['url']); ?>','<?php echo e($menu['id']); ?>','<?php echo e($menu_name); ?>',true);">
                <i class="fa fa-<?php echo e($menu['icon']); ?>"></i>
                <span class="menu-text"> <?php echo e($menu_name); ?> </span>
            </a>
            <?php }else{ ?>
            <a href="#" class="dropdown-toggle">
                <i class="fa fa-<?php echo e($menu['icon']); ?> normal"></i>
                <span class="menu-text normal"> <?php echo e($menu_name); ?> </span>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo e(url('admin/index/index')); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">管理后台</a>
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(1): ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="<?php echo e(asset('/static/themes/admin_simpleboot3/public/assets/images/logo-18.png')); ?>" alt="<?php echo e($user); ?>">
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="<?php echo e(asset('/static/themes/admin_simpleboot3/public/assets/images/logo-18.png')); ?>" alt="">
                        <?php endif; ?>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
                        ...
                        <li><a href="<?php echo e(url('admin/logins/logout')); ?>"><i class="fa fa-sign-out"></i> 退出登录</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            <a class="btn btn-sm btn-warning" href="<?php echo e(url('admin/index/index')); ?>"
               title="首页"
          ...
          <!--   <if condition="cmf_auth_check(cmf_get_current_admin_id(),'user/AdminAsset/index')">
            ...
            <if condition="APP_DEBUG">
                <a class="btn btn-sm btn-default"
                   href="javascript:openapp('<?php echo e(url('admin/menu/index')); ?>','index_menu','菜单管理',true);"
                   title="菜单管理"
                   data-toggle="tooltip">
    ...
    <div class="main-content">
        <div class="page-content" id="content">
            <iframe src="<?php echo e(url('admin/index/main')); ?>" style="width:100%;height: 100%;" frameborder="0" id="appiframe-0"
...
<script src="<?php echo e(asset('/static/themes/admin_simpleboot3/public/assets/simpleboot3/js/adminindex.js')); ?>"></script>
<script>
    $(function () {
