...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo e(url('admin/container/add')); ?>">添加体验店</a></li>
        <li><a href="<?php echo e(url('admin/container/excel')); ?>">批量添加</a></li>
    </ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" id="form" action="<?php echo e(url('admin/container/add')); ?>">
...
<script>
	...
	$("#container_number").mouseleave(function(){
		...
		console.log(number);
		var url = "<?php echo e(url('admin/container/checkNumber')); ?>";
		// 异步提交验证
		$.ajax({
			type:"post",
			url:url,
