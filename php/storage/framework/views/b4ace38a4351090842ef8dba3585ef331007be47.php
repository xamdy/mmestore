        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body home-info">
                ...
                <ul class="home-info-ulchild">
                    <li><?php echo e(isset($todayOrder[0]['price']) ? $todayOrder[0]['price'] : '0'); ?></li>
                    <li><?php echo e(isset($weekOrder[0]['price']) ? $weekOrder[0]['price'] : '0'); ?></li>
                    <li><?php echo e(isset($monthOrder[0]['price']) ? $monthOrder[0]['price'] : '0'); ?></li>
                </ul>
            </div>
            ...
            <div class="panel-body home-info">
                ...
                <ul class="home-info-ulchild">
                    <li><?php echo e($todayOrder[0]['count']); ?></li>
                    <li><?php echo e($weekOrder[0]['count']); ?></li>
                    <li><?php echo e($monthOrder[0]['count']); ?></li>
                </ul>
            </div>
...
<script src="<?php echo e(asset('/js/echarts/echarts.min.js')); ?>"></script>
...
<script>
    ...
    $(function() {
        $.ajax({
            type: 'post',
            url: "<?php echo e(url('admin/index/hotelOrderRank')); ?>",
...
//                char(data.time,data.count)
    ...
    $(function() {
        $.ajax({
            type: 'post',
            url: "<?php echo e(url('admin/index/hotelPriceRank')); ?>",
    ...
    $('#remove').change(function(){
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo e(url('admin/index/orderRank')); ?>",
...
//                type: 'bar'
    ...
    $('#rankPrice').change(function(){
        ...
        $.ajax({
            type: 'post',
            url: "<?php echo e(url('admin/index/priceRank')); ?>",
            data: {_token: _token,type:type},
            dataType: 'json',
            success: function (data) {
